...
リニアサーチ
l71 IDをMAXCITY＝２１まで検索し、IDが一致すれば配列のindexをresultに代 　　入する。一致するものがなければposを進める

バイナリーサーチ
     leftとrightに配列のindexにおける最大値を最小値をそれそれ代入する
l89　rightがleftとり大きければ繰り返し施行を行う
l90  indexの値は中央値をとる
l91  keyとIDga一致する場合終了
l95  keyの方が大きけらば、検索の範囲を半分より大きい方に絞る
l98  keyの方が小さければ、検索の範囲を半分より小さい方に絞る
